...
import dashboardConfig from "@/configs/nav-config/modules/dashboard-config.json";
...
// Dashboard module currently has no additional tabs
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <TabProvider staticTabs={staticTabs}>
      <DynamicModuleSidebar config={dashboardConfig as any} userPermissions={permissions} />
