...
import inventoryConfig from "@/configs/nav-config/modules/inventory-config.json";
...
const staticTabs: Tab[] = [{ id: "inventory-dashboard", label: "Inventory Dashboard", path: "/inventory", type: "list" }];
...
export default function InventoryLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <TabProvider staticTabs={staticTabs}>
            <DynamicModuleSidebar config={inventoryConfig as any} userPermissions={permissions} />
