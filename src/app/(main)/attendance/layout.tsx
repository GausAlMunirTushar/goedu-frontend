...
import attendanceConfig from "@/configs/nav-config/modules/attendance-config.json";
...
// Attendance module currently has no additional tabs
...
export default function AttendanceLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <TabProvider staticTabs={staticTabs}>
      <DynamicModuleSidebar config={attendanceConfig as any} userPermissions={permissions} />
