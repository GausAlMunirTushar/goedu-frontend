...
const badgeVariants = cva(
    "inline-flex items-center justify-center rounded-full border px-2 py-0.5 text-xs font-medium w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-colors overflow-hidden",
    {
        variants: {
            variant: {
                default: "bg-primary/10 text-primary border-primary/30 [a&]:hover:bg-primary/20",
                secondary:
                    "bg-secondary-100 text-secondary-700 border-secondary-300 [a&]:hover:bg-secondary-200",
                destructive: "bg-red-100 text-red-700 border-red-300 [a&]:hover:bg-red-200",
                success: "bg-green-100 text-green-700 border-green-300 [a&]:hover:bg-green-200",
                warning: "bg-yellow-100 text-yellow-700 border-yellow-300 [a&]:hover:bg-yellow-200",
                outline:
